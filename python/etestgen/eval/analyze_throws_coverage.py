...
class ThrowsCoverageAnalyzer:
    ...
    def __init__(
        ...
        repos_file: su.arg.RPath = Macros.repos_dir / "filtered" / "repos.json",
    ):
    ...
    def analyze(
        self,
        out_dir: su.arg.RPath = Macros.work_dir / "coverage",
    ...
    def analyze_module(
        ...
        proj_module_dir = Macros.downloads_dir / project / module
    ...
    def print_uncovered_module(
        ...
        results_dir: su.arg.RPath = Macros.work_dir / "coverage",
    ):
